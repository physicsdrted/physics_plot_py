...
# --- FINAL CORRECTED CSS ---
# This CSS targets the image generated by st.pyplot and constrains its height
# while letting the browser automatically adjust the width to maintain aspect ratio.
st.markdown("""
<style>
